...
/*
    Funzione che inserisce un nuovo elemento (new_elem) tra prev e next

    new_elem: nuovo elemento da inserire
    prev: elemento che deve precedere new_elem
    next: elemento che deve seguire new_elem
*/
...
/*
    Funzione che inserisce un nuovo elemento (new_elem) in testa alla lista head.

    new_elem: nuovo elemento da inserire
    head: lista in cui inserire new_elem
...
/*
    Come list_add, ma inserisce l'elemento new_elem in coda
